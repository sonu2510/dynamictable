...
@section('header')
                    ...
                    <div class="col-7 align-self-center">
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <div class="m-r-10">
                                {!! (new \App\Helpers\Helper)->Combo_Button_add('/machine_master/new',"Machine") !!}
                            </div>
...
@section('content')  
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Machine Index</h4>
                                <div class="table-responsive">
                                    <table class="table v-middle" id="machine">
                                         <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th class="no-sort hidden-sm-down">Machine Number</th>
                                                <th class="no-sort hidden-sm-down">Machine Slug</th>
...
$(function() {
    $dataTable = $('#machine').DataTable({
        ...
        serverSide: true,
        ajax: {
            url : '/machine_master/datatable/ajax',
            type:'GET',
        },
        aoColumns: [
            { data: 'machine_master_id', name: 'machine_master_id',orderable: false, searchable: false },
            { data: 'machine_name', name: 'machine_name' },
            { data: 'machine_slug', name: 'machine_slug' },
