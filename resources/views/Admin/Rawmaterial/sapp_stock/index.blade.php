...
@section('header')
                    ...
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Sapp Wire Stock</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                     <li class="breadcrumb-item active" aria-current="page">SAPP Stock Index</li>                                    
                                </ol>
                            </nav>
                        </div>
                    </div>
...
@section('content')  
                ...
                <div class="row">
                    <div class="col-sm-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">SAPP Stock Index</h4>
                                <div class="table-responsive">
                                    <table class="table v-middle" id="sapp">
...
$(function() {
     ...
     $('#sapp tfoot th').each( function (i) {
     if(i>=1 && i<=5){
        var title = $('#sapp thead th').eq( $(this).index() ).text();
        $(this).html( '<input type="text" placeholder="Search '+title+'" data-index="'+i+'" />' );
        }
    } );

    var table = $('#sapp').DataTable({
        processing: true,
        serverSide: true,
        ajax: {
            url : '/sapp_stock/datatable/ajax',
            type:'GET',
        },
        aoColumns: [
