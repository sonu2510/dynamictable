...
<head>
    ...
    <title>Skill Precison Balls Pvt. Ltd.</title>
    <!-- Custom CSS -->
    ...
    <div class="main-wrapper">
        ...
        <div class="error-box">
            <div class="error-body text-center">
                ...
                <a href="" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Please Contact the Administrator</a><br>
                <a href="/home" class="btn btn-danger btn-rounded waves-effect waves-light m-b-40">Go Back</a>
            </div>
        </div>
